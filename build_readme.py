...
def fetch_code_time():
    return httpx.get(
        "https://https://gist.github.com/YGcatswhite/784cdba5d71a29b088a23ea648ed36ae/raw/"
    )

def fetch_douban():
    entries = feedparser.parse("https://www.douban.com/feed/people/246644792/interests")["entries"]
    return [
        {
            "title": item["title"],
...
def fetch_zhihu():
    entries = feedparser.parse("https://www.douban.com/people/246644792/interests")["entries"]
    return entries
